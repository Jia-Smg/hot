...
target_k_horizontal = 250
target_k_vertical = 350
...
if __name__ == '__main__':
    model = torch.load('../../train_model/model-2024_05_25-19_28_20/model.pth')

    # ga = GA(func = worker, n_dim = 8, size_pop = 300, max_iter=400, prob_mut=0.01, lb=0.01, ub=0.49, precision=1e-5)
    ga = GA(func = worker, n_dim = 8, size_pop = 300, max_iter=1000, prob_mut=0.01, lb=0.01, ub=0.49, precision=1e-4)
